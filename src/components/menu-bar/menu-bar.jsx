...
class MenuBar extends React.Component {
    ...
    handleLogInSubmit(data) {
        ...
        const loginResponse = this.props.onLogInMenu(data);
                        ...
                        <div className={classNames(styles.editMenu)}>
                            ...
                            >
                                ...
                                <LoginDropdown
                                    ...
                                    onLogInSubmit={(data)=>this.handleLogInSubmit(data)}
...
const mapDispatchToProps = dispatch => ({
    ...
    onLogInMenu: (data) => dispatch(handleLogIn(data))
});
